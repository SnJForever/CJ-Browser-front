  ...
  <div id="notes-list">
    <div id="search-buttons" class="columns">
      <div id="search">
        <b-field>
          <b-input
            placeholder="Search by name, description or brower type..."
            v-model="searchField"
            type="search"
            icon="search"
          ></b-input>
      ...
      <div id="buttons">
        <button
          ...
          v-if="settingsModalActive = false"
        >
    ...
    >
      ...
      >
        <h1>Hey !</h1>
        <h2>You don't have any {{ gistsSelected ? "gist" : "brower" }}...</h2>
      ...
      <div v-if="!settings.githubPersonalAccessToken && gistsSelected">
        <div class="column is-8 is-offset-2 no-token">
          ...
          <h2>
            ...
            <a @click="settingsModalActive = false">settings</a>.
          </h2>
        </div>
      </div>
    </div>
    ...
    <modal
      ...
      :min-height="550"
    >
      <cn-create-brower-modal></cn-create-brower-modal>
    </modal>
...
import CreateBrowerModal from "../modals/create-brower-modal/CreateBrowerModal";
...
const createNoteBrowerName = "create-brower-modal";
...
export default {
  ...
  components: {
    ...
    "cn-create-brower-modal": CreateBrowerModal,
  ...
  methods: {
    ...
    showCreateBrowerModal() {
      console.log("111111")
      this.$modal.show(createNoteBrowerName);
    }
  },
  computed: {
    ...mapGetters([
    ...
    notesFiltered() {
      ...
      if (this.languageSelected !== "all") {
        ...
        notesFiltered.forEach(note => {
          if (
             note.form.os === this.languageSelected
          ) {
