    ...
    <div class="modal-card">
      <header class="modal-card-head">
        ...
        <h2 class="text-red" v-if="displayDupError">
          Oh sorry, you can't have duplicated name in your browers ...
        </h2>
      </header>
      ...
      <section class="modal-card-body">
        ...
        <CreateBrowerModal v-model="note.form" ref="browerModal" @childData="handleChildData"></CreateBrowerModal>
  ...
  methods: {
    ...
    createNote() {
      if (!this.containsDupFiles()) {
        this.$refs.browerModal.getBrowerData();
