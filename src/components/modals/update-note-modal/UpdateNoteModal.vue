    ...
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        ...
        <div class="note-file" v-for="(file, index) in files" :key="index">
          <b-field horizontal label="Code" grouped>
            <b-input
              style="width: 186px"
              type="text"
              v-model="file.name"
          ...
          <b-field horizontal label="Language"  v-if=false>
            <b-select
          ...
          <b-field horizontal label="Content"  v-if=false>
            <editor
        ...
        <CreateBrowerModal v-model="noteUpdated.form" ref="updateBrowerModal" @childData="handleChildUpdateData"></CreateBrowerModal>
...
import CreateBrowerModal from "@/components/modals/create-brower-modal/CreateBrowerModal";
...
export default {
  ...
  mounted() {
    ...
    this.$refs.updateBrowerModal.handleUpdate(this.note.form);
  ...
  methods: {
    ...
    handleChildUpdateData(data) {
      this.noteUpdated.form = data;
    },
    updateNoteModal() {
      if (!this.containsDupFiles()) {
        ...
        this.$refs.updateBrowerModal.getBrowerUpdateData();
