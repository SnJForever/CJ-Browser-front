    ...
    <el-scrollbar style="
      ...
      <div
              ...
              <div>
                ...
                >
                  ...
                  <div style="display: flex; align-items: flex-start">
                    ...
                    />
                    <el-input v-model="cookieFormat" type="textarea" :rows="19" disabled/>
        ...
        <!-- <div slot="footer" class="dialog-footer">
          <el-button size="medium" @click="dialogFormVisible = false;$modal.hide('create-brower-modal')">
            {{ $t("browser.cancel") }}
          </el-button>
          <el-button
            type="primary"
            size="medium"
            @click="dialogStatus === 'create' ? onCreateData() : onUpdateData();$modal.hide('create-brower-modal')"
          >
            {{ $t("browser.confirm") }}
          </el-button>
        </div> -->
